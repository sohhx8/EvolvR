...
filenames = ["JDHS03B_S2_L001_","JDHS03D_S4_L001_","JDHS03E_S5_L001_","JDHS03C_S3_L001_","JDHS03A_S1_L001_"]
...
fig1=matplotlib.pyplot.scatter(pos2,freq2, color='blue',label = r'$\bf{nCas9-PolI3M on target replicate 1}$')
fig1=matplotlib.pyplot.scatter(pos4,freq4, color='orange', label = r'$\bf{nCas9-PolI3M on target replicate 2}$')
...
ax.set_yscale('log')
plt.ylim([0.04,2])
plt.xlim([-8,59]) #this removes the first and last 5 nucleotides to remove the low fidelity region of the reads from the analysis
plt.tight_layout()
# matplotlib.pyplot.show()
plt.savefig("NGSfig.eps", format="eps")
